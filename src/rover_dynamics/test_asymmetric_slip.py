...
# Different slip on each side
slip_left = SlipModel(
    slip_ratio=0.10
)

slip_right = SlipModel(
    slip_ratio=0.40
)
...
# Apply asymmetric slip

real_force_left = slip_left.apply_slip(
    ideal_force_left
)

real_force_right = slip_right.apply_slip(
    ideal_force_right
)
...
print("Nominal:", nominal_state)
print("Real with asymmetric slip:", real_state)
